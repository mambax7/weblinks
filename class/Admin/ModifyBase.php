...
// class ModifyBase
//=========================================================
class ModifyBase extends Happylinux\Manage
{
    ...
    public function __construct()
    {
        ...
        $this->set_form_handler('LinkFormModApprove', WEBLINKS_DIRNAME, 'weblinks');

        $this->set_id_name('mid');
        $this->set_flag_execute_time(true);

        $this->_config_handler = weblinks_get_handler('Config2Basic', WEBLINKS_DIRNAME);
        $this->_check_handler = weblinks_get_handler('LinkFormCheck', WEBLINKS_DIRNAME);
        $this->_mail_template = Happylinux\MailTemplate::getInstance(WEBLINKS_DIRNAME);
        $this->_mail_form = Happylinux\MailForm::getInstance();
        $this->_mail_send = Happylinux\MailSend::getInstance();
