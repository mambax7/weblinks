...
// class ModifyNew
//=========================================================
class ModifyNew extends ModifyBase
{
    //---------------------------------------------------------
    // constructor
    //---------------------------------------------------------
    ...
    public function list_new()
    {
        ...
        if ($total > 0) {
            ...
            echo sprintf(_HAPPYLINUX_THERE_ARE, $total_s) . "<br><br>\n";
    ...
    public function _print_approve_new_preview()
    {
        $this->_print_cp_header();
