...
// class ImportMylinks
//=========================================================
class ImportMylinks110ToWeblinks120 extends Happylinux\BasicHandler
{
    ...
    public $_weblinks_catlink_handler;
    public $votedataHandler;
    public $_weblinks_votedata_table;

    public $_mylinks_cat_table;
    public $_mylinks_links_table;
    public $_mylinks_text_table;
    public $_mylinks_votedata_table;

    public $_xoopscomments_table;

    public $_weblinks_mid;
    public $_mylinks_mid;

    public $_weblinks_shots_url;
    public $_weblinks_shots_dir;
    public $_mylinks_shots_dir;
    ...
    public function __construct()
    {
        ...
        $this->votedataHandler->set_debug_db_error(1);
    ...
    public function import_link()
    {
        ...
        foreach ($rows2 as $row) {
            ...
            // new object
            $obj = new Weblinks\LinkSave(WEBLINKS_DIRNAME);
    ...
    // import_votedate
    //---------------------------------------------------------
    public function import_votedate()
    {
    ...
    public function re_create()
    {
        ...
        $magic = $this->votedataHandler->get_magic_word();
        $this->votedataHandler->drop_table($magic);
        $this->votedataHandler->create_table();
...
$import = ImportMylinks::getInstance();
