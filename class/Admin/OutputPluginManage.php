...
//=========================================================
class OutputPluginManage extends Happylinux\PluginManage
{
    //---------------------------------------------------------
    // constructor
    //---------------------------------------------------------
    ...
    {
        parent::__construct();
        $this->set_plugin_class(Htmlout::getInstance(WEBLINKS_DIRNAME));
    }
...
$manage = OutputPluginManage::getInstance();
