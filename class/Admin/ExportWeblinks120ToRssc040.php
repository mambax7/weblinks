...
//=========================================================
// class ExportWeblinks120ToRssc040
//=========================================================
class ExportWeblinks120ToRssc040 extends Happylinux\BasicHandler
{
    public $_LIMIT = 100;

    public $_FLAG_UPDATE_RSSC = true;
    ...
    public $_weblinks_atomfeed_table;

    public $_weblinks_mid = 0;

    // rssc handler
    public $_rssc_link_handler;
    public $_rssc_black_handler;
    public $_rssc_white_handler;
    public $_rssc_feed_handler;
    public $_rssc_parse_handler;
    ...
    public function _get_rssc_feed_lid($arr)
    {
        $lid = $arr['lid'];
        $url = $arr['site_url'];
    ...
    public function _get_rssc_feed_uid($lid)
    {
        $ret = 0;
    ...
    public function _get_rssc_feed_p1($lid)
    {
        $ret = 0;
        $obj = &$this->_get_rssc_link_obj_by_lid($lid);
        if (is_object($obj)) {
    ...
    public function &_get_rssc_link_obj_by_lid($lid)
    {
        $obj = false;
    ...
    public function _exist_rssc_feed($link)
    {
...
$export = ExportWeblinks120ToRssc040::getInstance();
$op = 'main';
if (isset($_POST['op'])) {
    $op = $_POST['op'];
}
