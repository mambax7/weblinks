...
//================================================================
class ConfigForm extends Weblinks\Config2Form
{
    // handler
    public $_linkitem_form;
    public $_system;
    public $_dir;
    public $_menu;
    ...
    public function __construct()
    {
        ...
        $this->_linkitem_form = Weblinks\LinkitemForm::getInstance(WEBLINKS_DIRNAME);
        $this->_system = Happylinux\System::getInstance();
        $this->_dir = Happylinux\Dir::getInstance();
        $this->_menu = ConfigMenu::getInstance();
    ...
    {
        $dirname = 'modules/happylinux/locate/';
    ...
    {
        echo $this->build_lib_box_button_style($title, _AM_WEBLINKS_CONF_TEMPLATE_DESC, 'template_compiled_clear', _HAPPYLINUX_CLEAR);
        echo "<br>\n";
    }
    ...
    // print html
    //---------------------------------------------------------
    public function print_form_bottom()
    {
    ...
    // module installed
    //---------------------------------------------------------
    public function print_rssc_module_installed()
    {
    ...
    public function print_d3forum_module_installed()
    {
        $dirname = $this->configDefineHandler->get_by_name('d3forum_dirname', 'value');
        $this->print_module_installed($dirname, 'd3forum');
    }

    public function print_module_installed_by_conf($kind, $conf_name)
    {
        $dirname = $this->configDefineHandler->get_by_name($conf_name, 'value');
