...
if (!class_exists('weblinks_rssc_handler')) {
    ...
    // class weblinks_rssc
    //=========================================================
    class weblinks_rssc extends Happylinux\BasicObject
    {
    ...
    //=========================================================
    class weblinks_rssc_handler extends Happylinux\Error
    {
        // handler
    ...
    //---------------------------------------------------------
    class weblinks_rssc_form extends Happylinux\FormLib
    {
        public $_rssc_link_xml_handler;
