...
// === class begin ===
if (!class_exists('CategoryLinkHandler')) {

    //=========================================================
    // class CategoryLinkHandler
    //=========================================================
    class CategoryLinkHandler extends Happylinux\BaseObjectHandler
    {
        ...
        {
            parent::__construct($dirname, 'catlink', 'jid', 'CategoryLink');
            ...
            $this->_catlink_basic_handler = weblinks_get_handler('CategoryLinkBasic', $dirname);
        }
