...
if (!class_exists('LinkViewBasic')) {
    ...
    // class LinkViewBasic
    //=========================================================
    class LinkViewBasic extends happy_linux_basic
    {
        public $_DIRNAME;
        ...
        public function build_show_basic()
        {
            // dont show
            $this->set('passwd', '');
            $this->set('search', '');
        ...
        public function _set_sanitize_all()
        {
            // MUST copy
            $arr = $this->get_vars();
        ...
        public function _set_name_mail_disp()
        {
        ...
        public function _set_array_addr_urlencode()
        {
        ...
        public function _set_gm_desc_wrap()
        {
