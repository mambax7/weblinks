<{* $Id: weblinks_block_rate.html.\040CDS\040Patch.html,v 1.1 2012/04/09 10:22:24 ohwada Exp $ *}>
...
<ul>
    ...
    <li>
        ...
        <{/if}>
        <a href="<{$xoops_url}>/modules/<{$block.dirname}>/singlelink.php?lid=<{$link.id}>"><{$link.title}></a> (<{$link.rates}>)
        <{if $link.show_new == 1}>
