<{* $Id: weblinks_block_atom.html.\040CDS\040Patch.html,v 1.1 2012/04/09 10:22:23 ohwada Exp $ *}>
...
<ul>
    ...
    <li>
        ...
        <br>
        &nbsp; <{$smarty.const._WEBLINKS_FROM}> <a href="<{$feed.site_url}>" target="_blank"><{$feed.site_title}></a>
