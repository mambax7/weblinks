<{* $Id: weblinks_viewmark.html.\040CDS\040Patch.html,v 1.1 2012/04/09 10:21:09 ohwada Exp $ *}>
                            ...
                            <a href="<{$xoops_url}>/modules/<{$dirname}>/viewmark.php?mark=<{$mark}>&amp;sortid=5&amp;keywords=<{$keywords}>">
                                ...
                                <a href="<{$xoops_url}>/modules/<{$dirname}>/viewmark.php?mark=<{$mark}>&amp;sortid=6&amp;keywords=<{$keywords}>">
                                    ...
                                    <a href="<{$xoops_url}>/modules/<{$dirname}>/viewmark.php?mark=<{$mark}>&amp;sortid=7&amp;keywords=<{$keywords}>">
                                        ...
                                        <{$lang_publish}> (
                                        <{if $keywords != '' }>
                                        <a href="<{$xoops_url}>/modules/<{$dirname}>/viewmark.php?mark=<{$mark}>&amp;sortid=8&amp;keywords=<{$keywords}>">
                                            <{else}>
                                            <a href="<{$xoops_url}>/modules/<{$dirname}>/viewmark.php?mark=<{$mark}>&amp;sortid=8">
                                                <{/if}>
                                                <img src="<{$xoops_url}>/modules/<{$dirname}>/images/up.gif" border="0" align="middle" alt="<{$lang_sort_8}>"/></a>
                                            <{if $keywords != '' }>
                                            <a href="<{$xoops_url}>/modules/<{$dirname}>/viewmark.php?mark=<{$mark}>&amp;sortid=9&amp;keywords=<{$keywords}>">
                                                <{else}>
                                                <a href="<{$xoops_url}>/modules/<{$dirname}>/viewmark.php?mark=<{$mark}>&amp;sortid=9">
                                                    <{/if}>
                                                    <img src="<{$xoops_url}>/modules/<{$dirname}>/images/down.gif" border="0" align="middle" alt="<{$lang_sort_9}>"/></a>) <br>
...
<hr/>
    ...
    <div class="weblinks_viewmark_kml_frame">
        ...
        <a href="<{$xoops_url}>/modules/<{$dirname}>/kml/kml.php?page=<{$kml.page}>&amp;limit=<{$kml_perpage}>" target="_blank">
            [<{$smarty.const._WEBLINKS_FILE}> <{$kml.page}>]</a>
        <{/foreach}>
    </div>
<br>
    <{* -- End kml loop -- *}>
