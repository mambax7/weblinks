...
<head>
    <{* $Id: weblinks_print.html.\040CDS\040Patch.html,v 1.1 2012/04/09 10:21:09 ohwada Exp $ *}>
...
<br><br>
    ...
    <div class="weblinks_print_frame_feed_all">
        ...
        <div class="weblinks_print_frame_feed_each">
            ...
            &nbsp; <{$smarty.const._WEBLINKS_FROM}> <{$feed.site_title}>&nbsp;
        ...
        <{/foreach}>
        <{else}>
        <span class="weblinks_blue"><{$smarty.const._WEBLINKS_NOFEED}></span>
        <{/if}>
    </div>
    <{* -- feed list end -- *}>
