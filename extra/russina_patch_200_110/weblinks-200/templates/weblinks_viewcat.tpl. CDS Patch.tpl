<{* $Id: weblinks_viewcat.html.\040CDS\040Patch.html,v 1.1 2012/04/09 10:21:09 ohwada Exp $ *}>
                                            ...
                                            <a href="<{$xoops_url}>/modules/<{$dirname}>/viewcat.php?cid=<{$category.cid}>&amp;sortid=5&amp;keywords=<{$keywords}>">
                                                ...
                                                <a href="<{$xoops_url}>/modules/<{$dirname}>/viewcat.php?cid=<{$category.cid}>&amp;sortid=6&amp;keywords=<{$keywords}>">
                                                    ...
                                                    <a href="<{$xoops_url}>/modules/<{$dirname}>/viewcat.php?cid=<{$category.cid}>&amp;sortid=7&amp;keywords=<{$keywords}>">
                                                        ...
                                                        <{$lang_publish}> (
                                                        <{if $keywords != '' }>
                                                        <a href="<{$xoops_url}>/modules/<{$dirname}>/viewcat.php?cid=<{$category.cid}>&amp;sortid=8&amp;keywords=<{$keywords}>">
                                                            <{else}>
                                                            <a href="<{$xoops_url}>/modules/<{$dirname}>/viewcat.php?cid=<{$category.cid}>&amp;sortid=8">
                                                                <{/if}>
                                                                <img src="<{$xoops_url}>/modules/<{$dirname}>/images/up.gif" border="0" align="middle" alt="<{$lang_sort_8}>"/></a>
                                                            <{if $keywords != '' }>
                                                            <a href="<{$xoops_url}>/modules/<{$dirname}>/viewcat.php?cid=<{$category.cid}>&amp;sortid=9&amp;keywords=<{$keywords}>">
                                                                <{else}>
                                                                <a href="<{$xoops_url}>/modules/<{$dirname}>/viewcat.php?cid=<{$category.cid}>&amp;sortid=9">
                                                                    <{/if}>
