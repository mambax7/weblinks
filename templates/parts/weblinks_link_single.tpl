<{* $Id: weblinks_link_single.html,v 1.3 2012/04/09 10:20:07 ohwada Exp $ *}>
            ...
            <table class="weblinks_link_single_title">
                <tr>
                    <td class="weblinks_link_single_title_left">
                        ...
                        <{if ($link.mode_singlelink != 1)&&($link.mode_url_summary == 3) }>
                        <a href="<{$xoops_url}>/modules/<{$dirname}>/singlelink.php?lid=<{$link.lid}>">
                            <{elseif ($link.flag_url == 1)||($link.mode_url_summary == 1)}>
                            <a href="<{$xoops_url}>/modules/<{$dirname}>/visit.php?lid=<{$link.lid}>" target="_blank">
                                <{elseif ($link.flag_url == 2)||($link.mode_url_summary == 2)}>
