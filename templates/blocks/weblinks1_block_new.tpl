<{* $Id: weblinks1_block_new.html,v 1.2 2012/04/09 10:20:06 ohwada Exp $ *}>
        ...
        <td width="50%">
            ...
            <ul>
                ...
                <li>
                    ...
                    <{/if}>
                    <a href="<{$xoops_url}>/modules/<{$block.dirname}>/singlelink.php?lid=<{$link.id}>"><{$link.title_disp}></a> (<{$link.date_short}>)
                    <{if $link.show_new }>
        ...
        <td width="50%">
            <ul>
                ...
                <li>
                    ...
                    <{/if}>
                    <a href="<{$xoops_url}>/modules/<{$block.dirname}>/singlelink.php?lid=<{$link.lid}>"><{$link.title_disp}></a> (<{$link.date_short}>)
                    <{if $link.show_new }>
                    <img src="<{$xoops_url}>/modules/<{$block.dirname}>/images/new.gif" border="0" alt="new"/>
                    <{/if}>
                    <{if $link.show_update }>
