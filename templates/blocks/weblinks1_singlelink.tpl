<{* $Id: weblinks1_singlelink.html,v 1.1 2007/08/08 04:20:58 ohwada Exp $ *}>
...
<{if !$link.flag_time_publish}>
<span class="weblinks_waning"><{$lang_warn_time_publish}></span><br>
<{$link.time_publish_long}><br>
<{/if}>

<{if !$link.flag_time_expire}>
<span class="weblinks_waning"><{$lang_warn_time_expire}></span><br>
<{$link.time_expire_long}><br>
<{/if}>

<{if !$link.flag_broken}>
<span class="weblinks_waning"><{$lang_warn_broken}></span><br>
...
<div class="weblinks_singlelink_frame">
    ...
    <a href="<{$xoops_url}>/modules/<{$dirname}>/index.php?keywords=<{$keywords}>"><{$lang_main}></a>&nbsp;
    <img src="<{$xoops_url}>/modules/<{$dirname}>/images/arrow1.gif" border="0" alt="arrow"/>&nbsp;
    <{section name=j loop=$catpaths[i]}>
    <a href="<{$xoops_url}>/modules/<{$dirname}>/viewcat.php?cid=<{$catpaths[i][j].cid}>&amp;keywords=<{$keywords}>"><{$catpaths[i][j].title_s}></a>
