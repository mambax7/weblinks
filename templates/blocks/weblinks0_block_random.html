<{* $Id: weblinks0_block_random.html,v 1.2 2012/04/09 10:20:06 ohwada Exp $ *}>
<{* same as weblinks_block_generic.html *}>
<{* hacked by hiro https://ishinomaki.cc/ *}>
...
<ul>
    ...
    <li>
        ...
        <a href="<{$xoops_url}>/modules/<{$block.dirname}>/visit.php?lid=<{$link.lid}>" target="_blank">
