<{* $Id: weblinks2_block_rate.html,v 1.2 2012/04/09 10:20:06 ohwada Exp $ *}>
...
<ul>
    ...
    <li>
        ...
        <{/if}>
        <a href="<{$xoops_url}>/modules/<{$block.dirname}>/singlelink.php?lid=<{$link.lid}>"><{$link.title_disp}></a> (<{$link.rating_disp}>)
        <{if $link.show_new == 1}>
