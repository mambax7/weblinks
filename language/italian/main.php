...
if (!defined('WEBLINKS_LANG_MB_LOADED')) {
    ...
    define('_WLS_TAKESHOT', 'Prenderemo uno screenshot del tuo sito web e ci potr� volere qualche giorno prima che il link al sito sia aggiunto al nostro database.');
    define('_WLS_ALLPENDING', "L\'invio Link sar� registrato e sar� pubblicato dopo la verifica. ");
    ...
    define('_WLS_TOPRATED', 'Pi� votato');

    define('_WLS_NEWTHISWEEK', 'Nuovi questa settimana');
    define('_WLS_UPTHISWEEK', 'Aggiornati questa settimana');

    define('_WLS_POPULARITYLTOM', 'Popolarit� (dai meno ai pi� cliccati)');
    define('_WLS_POPULARITYMTOL', 'Popolarit� (dai pi� ai meno cliccati)');
    ...
    define('_WLS_RATINGLTOH', 'Voti (Da punteggio pi� basso al pi� alto)');
    define('_WLS_RATINGHTOL', 'Voti (Da punteggio pi� alto al pi� basso)');
    ...
    define('_WLS_LATESTLIST', 'Aggiunte pi� recenti');
    ...
    define('_WLS_NOTIFYAPPROVE', 'Notificami quando questo link � approvato');
    define('_WLS_SHOTIMAGE', 'Screenshot: ');
    define('_WLS_SENDREQUEST', 'Invia Richiesta');

    define('_WLS_VOTEAPPRE', 'Il tuo voto � apprezzato.');
    define('_WLS_THANKURATE', 'Grazie per il tempo dedicato per votare un sito qui su %s.');
    define('_WLS_VOTEFROMYOU', 'Il riscontro da utenti come te aiuter� altri visitatori a decidere meglio quali link scegliere.');
    define('_WLS_VOTEONCE', 'Per favore non votare lo stesso sito pi� di una volta.');
    define('_WLS_RATINGSCALE', 'La scala � 1 - 10, dove 1 indica scadente e 10 indica eccellente.');
    ...
    define('_WLS_INTLINKFOUND', 'Questo � un link a un sito interessante che ho trovato su %s');  // %s is your site name
    ...
    define('_WLS_POPULARITY', 'Popolarit�');
    ...
    define('_WLS_ALREADYREPORTED', 'Hai gi� inviato una segnalazione link non valido per questa risorsa.');
    ...
    define('_WLS_LINKIMAGEMUST', " Inserisci nome file immagine link sotto directory %s. (es. shot.gif) Lascia il campo vuoto se non c'� file immagine. ");
    ...
    define('_WLS_IMGURL', 'URL Immagine (OPZIONALEL Altezza immagine sar� ridim. a 50): ');
    ...
    define('_WLS_IMGURLMAIN', 'URL Immagine (OPZIONALE e valida solo per categorie principali. Altezza immagine sar� ridim. a 50): ');
    ...
    define('_WLS_SITE_HIGHRATE', 'Sito pi� votato');
    ...
    define('_WLS_NEW_SITELIST', 'Sito pi� recente');
    define('_WLS_NEW_ATOMFEED', 'RSS/ATOM Feed pi� recente');
    ...
    define('_WLS_ERROR_URL_EXIST', 'Errore: Il link � stato gi� registrato. ');
    define('_WLS_WARNING_URL_EXIST', 'Attenzione: Un link simile � stato gi� registrato. ');
    ...
    define('_MANY_MATCH_RECORD', 'Ci sono due o pi� record corrispondenti');
    ...
    // config
    define('_WEBLINKS_INIT_NOT', 'La tabella config non � inizializzata');
    define('_WEBLINKS_INIT_EXEC', 'Tabella Config inizializzata');
    define('_WEBLINKS_VERSION_NOT', 'Questo modulo non � alla versione %s. Aggiorna ora');
    ...
    define('_WEBLINKS_GM_GET_LOCATION', 'Le informazioni sulla localit� sono prese da GoogleMaps');
    //define('_WEBLINKS_GM_GET_BUTTON', 'Get Latitude/Longitude/Zoom');
    define('_WEBLINKS_GM_DEFAULT_LOCATION', 'Localit� Default');
    define('_WEBLINKS_GM_CURRENT_LOCATION', 'Localit� attuale');

    // === 2006-11-04 ===
    // google map inline mode
    define('_WEBLINKS_GOOGLE_MAPS', 'Google Maps');
    define('_WEBLINKS_JAVASCRIPT_INVALID', 'Il tuo browser non utilizza JavaScript');
    define('_WEBLINKS_GM_NOT_COMPATIBLE', 'Il tuo browser non pu� accedere a GoogleMaps');
    ...
    define('_WEBLINKS_WARN_TIME_PUBLISH', 'L\'ora pubblicazione non � ancora trascorsa');
    ...
    define('_WEBLINKS_TIME_PUBLISH_DESC', 'Se non marcato, l\'ora di pubblicazione non sar� indicata');
