...
if (!defined('WEBLINKS_LANG_MI_LOADED')) {
    ...
    define('_MI_WEBLINKS_SMNAME3', 'Sito pi� votato');
    ...
    //-------------------------------------
    define('_MI_WEBLINKS_POPULAR', 'Num. di hits necessari perch� un link sia marcato come Popolare');
    ...
    define('_MI_WEBLINKS_ORDERBY6', 'Popolarit� (ordine ascendente)');
    define('_MI_WEBLINKS_ORDERBY7', 'Popolarit� (ordine discendente)');
    ...
    define('_MI_WEBLINKS_TOPTEN_STYLE_DSC', 'Scegli stile in "Siti Popolari" e "Siti pi� votati". ');
    ...
    define('_MI_WEBLINKS_TOPTEN_LINKS_DSC', 'Inserire il num. max di link da visual. in "Siti Popolari" e "Siti pi� votati". ');

    define('_MI_WEBLINKS_TOPTEN_CATS', 'Num. max categorie in topten');
    define('_MI_WEBLINKS_TOPTEN_CATS_DSC', 'Inserire il num. max di categorie da visual. in "Siti Popolari" e "Siti pi� votati". <br>Pu� esserci un timeout se si selezionano troppe categorie');
