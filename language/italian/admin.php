...
if (!defined('WEBLINKS_LANG_AM_LOADED')) {
    ...
    define('_WEBLINKS_AUTH_SUBMIT', 'Pu� inviare un nuovo link');
    define('_WEBLINKS_AUTH_SUBMIT_DSC', 'Specifica i gruppi autorizzati a inviare un nuovo link');
    define('_WEBLINKS_AUTH_SUBMIT_AUTO', 'Pu� approvare automaticamente i nuovi link inviati');
    define('_WEBLINKS_AUTH_SUBMIT_AUTO_DSC', 'Specifica i gruppi il cui invio di link � automaticamente approvato');
    define('_WEBLINKS_AUTH_MODIFY', 'Pu� modificare');
    define('_WEBLINKS_AUTH_MODIFY_DSC', 'Specifica i gruppi autorizzati a inviare richieste di modifica link');
    define('_WEBLINKS_AUTH_MODIFY_AUTO', 'Pu� approvare modifiche link');
    define('_WEBLINKS_AUTH_MODIFY_AUTO_DSC', 'Specifica i gruppi autorizzati ad approvare richieste di modifica link');
    define('_WEBLINKS_AUTH_RATELINK', 'Pu� votare un link');
    define('_WEBLINKS_AUTH_RATELINK_DSC', 'Specifica i gruppi autorizzati a votare un link.<br>Questa opzione funziona solo quando � attiva la funzione di voto.');
    define('_WEBLINKS_USE_PASSWD', 'Usa Autenticazione Password quando si modifica un link');
    define('_WEBLINKS_USE_PASSWD_DSC', 'Se � selezionato SI, visualizza un campo Autenticazione Password, <br>per i gruppi che non sono autorizzati a inviare/approvare richieste di modifica. ');
    ...
    define(
        ...
        'Indica una lista di url da rifiutare nella raccolta di RSS/ATOM feeds. <br>Separare ciascun elemento con un a capo se se ne indica pi� di uno. <br>E\' possibile usare regular PERL expressions. '
    );
    define('_WEBLINKS_RSS_WHITE', 'White list di RSS/ATOM url');
    define(
        '_WEBLINKS_RSS_WHITE_DSC',
        'Indica una lista di url da accettare anche se corrispondenti ad una blacklist. <br>Separare ciascun elemento con un a capo se se ne indica pi� di uno. <br>E\' possibile usare regular PERL expression. '
    );
    ...
    define(
        ...
        'Inserire il numero massimo di caratteri da usare per il contenuto nella pagina RSS/ATOM.  <br>Utilizzato quando "Usa i tag HTML nel contenuto" � "S�"." '
    );
    ...
    define('_WEBLINKS_CAT_SEL_DSC', 'Indicare il numero massimo di categorie che un utente pu� scegliere per categorizzare i link inviati');
    ...
    define('_WEBLINKS_CAT_IMG_SIZE_DSC', 'Usate se "Immagine da Impostazioni" � attivo. ');
    ...
    define(
        ...
        'Pu� verificarsi un timeout, se ci sono molti link non validi. <br>Nel caso, per favore cambiare il valore numerico di limite e offset. <br>limite= 0, oppure Nessuna Restrizione.'
    );
    ...
    // 2005-10-20
    define('_WEBLINKS_LINK_APPROVED', 'Il tuo link � stato approvato');
    define('_WEBLINKS_LINK_REFUSED', 'Il tuo link � stato respinto');
    ...
    // config
    define('_AM_WEBLINKS_WARNING_NOT_WRITABLE', 'La directory non � scrivibile');
    ...
    define(
        ...
        'CAPTCHA � una tecnica di anti-spam.<br>Questa opzione richiede il modulo Captcha.<br>SI, <b>utenti anonimi</b> devono usare CAPTCHA quando aggiungono o modificano link.<br>NO non mostrare campi CAPTCHA.'
    );
    ...
    define('_AM_WEBLINKS_MODLINK_NOT_OWNER_DSC', 'Mostra se in modalit� "approvazione admin richiesta" e non � il proprietario');
    ...
    define('_AM_WEBLINKS_GM_GEOCODE_KIND', '[��?�] Tipo di Geocode');
    define(
        '_AM_WEBLINKS_GM_GEOCODE_KIND_DESC',
        'Cerca latitudine e longitudine da indirizzo<br><b>Risultato singolo</b><br>GClientGeocoder - getLatLng<br><b>Pi� risultati</b><br>GClientGeocoder - getLocations'
    );
    ...
    define('_AM_WEBLINKS_GM_TITLE_LENGTH_DESC', 'Num. max di caratteri per Titolo nel marker<br><b>-1</b> � illimitato');
    define('_AM_WEBLINKS_GM_DESC_LENGTH', '[Marker] Max caratteri per contenuto');
    define('_AM_WEBLINKS_GM_DESC_LENGTH_DESC', 'Num. max caratteri usati per contenuto nel marker<br><b>-1</b> � illimitato');
    define('_AM_WEBLINKS_GM_WORDWRAP', '[Marker] Max caratteri per a capo');
    define('_AM_WEBLINKS_GM_WORDWRAP_DESC', 'Num. max caratteri usati in ogni riga (a capo automatico) nel marker<br><b>-1</b> � illimitato');
    ...
    define('_AM_WEBLINKS_COLUMN_BIGGER_USE', 'Il numero di colonne etc � maggiore del numero in tabella link');
    ...
    define(
        ...
        'Se "No", mostra style sheet e Javascript in body tag<br>Se "Si", li mostra nell\'header tag, usando xoops module header<br>Pu� non funzionare con alcuni temi'
    );
    ...
    // === 2007-09-01 ===
    // auth
    define('_AM_WEBLINKS_AUTH_DELETE', 'Pu� cancellare');
    define('_AM_WEBLINKS_AUTH_DELETE_DSC', 'Specificare gruppi autorizzati a inviare richieste cancellazione link');
    define('_AM_WEBLINKS_AUTH_DELETE_AUTO', 'Pu� approvare cancellazione link');
    ...
    define('_AM_WEBLINKS_SUBJ_LINK_MOD_APPROVED', '[{X_SITENAME}] {X_MODULE}: La tua richiesta modifica link � stata approvata');
    define('_AM_WEBLINKS_SUBJ_LINK_MOD_REFUSED', '[{X_SITENAME}] {X_MODULE}: La tua richiesta modifica link � stata respinta');
    define('_AM_WEBLINKS_SUBJ_LINK_DEL_APPROVED', '[{X_SITENAME}] {X_MODULE}: La tua richiesta cancellazione link � stata approvata');
    define('_AM_WEBLINKS_SUBJ_LINK_DEL_REFUSED', '[{X_SITENAME}] {X_MODULE}: La tua richiesta cancellazione link � stata rifiutata');
