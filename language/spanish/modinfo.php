...
if (!defined('WEBLINKS_LANG_MI_LOADED')) {
    ...
    define('_MI_WEBLINKS_BROKENDSC',
           'Introduce el Número de enlaces rotos reportados para poner fin a una pantalla. <br /> Cuando por debajo de este valor, será considerado como un Error temporal, y no se hará nada. <br /> Cuando este valor sobre el enlace ya no se visualiza.');
