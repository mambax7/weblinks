...
if (!defined('WEBLINKS_LANG_MB_LOADED')) {
    ...
    define('_WLS_SUBMIT_USER_COMMENT',
           '"Comentário do administrador" deve ser uma opinião, comunicado, etc.<br />Está coluna não é mostrada na WEB.<br />Por favor, coloque na URL de seu site onde está linkado para este site, quando você precisar assinalar ccomo "Link recíproco".');
