...
if (!defined('WEBLINKS_LANG_AM_LOADED')) {
    ...
    define('_WEBLINKS_RSS_MODE_DATA_DSC',
           'ATOM FEED, usa osw dados na tabela Atom feed  após da análise. <br />XML usa os dados da tabela de links antes da análise. <br />Alguns dados possivelmente não serão salvos na tabela atom feed depois da filtragem. ');
    ...
    define('_WEBLINKS_RSS_BLACK_DSC',
           'Informe a lista de urls recusadas quando da coleta de feeds RSS/ATOM. <br />Separe cada entrada com uma nova linha, quando especificar mais de uma. <br />Você pode usar expressões regulares PERL. ');
    define('_WEBLINKS_RSS_WHITE', 'Lista branca de url RSS/ATOM');
    define('_WEBLINKS_RSS_WHITE_DSC',
           'Informe a lista de uls para coletar, quando combinadas com uma lista negra. <br />Separe cada entrada com uma nova linha, quando especificar mais de uma. <br />Você pode usar expressões regulares PERL. ');
    ...
    define('_WEBLINKS_RSS_MAX_CONTENT_DSC',
           'Informe o número máximo de caracteres a serem usados para o conteúdo feed RSS/ATOM na página RSS/ATOM.  <br />é usado quando "Usar tags HTML nos conteúdos" é "sim." ');
    ...
    define('_WEBLINKS_ADMIN_LINK_BROKEN_CHECK_CAUTION',
           'Um esgotamento do tempo possivelmente ocorra, se existirem muitos links quebrados. <br />Se isso ocorrer, por favor mude o valor numérico do limite e saia da configuração. <br />limite= 0, ou Sem restrições.');
    define('_WEBLINKS_ADMIN_LINK_BROKEN_CHECK_NOTICE',
           'Clicando o <b>ID do link</b> abre uma página de modificação do link. <br /><b>URL do Website</b> conduzirá você a um link de um website, quando clicado. <br />');
    ...
    define('_AM_WEBLINKS_VIEW_URL_DSC',
           'NENHUM <br />sem url ou &lt;a&gt; tag é mostrada.<br />Indireto<br /> mostra visit.php em href campo ao invés da URL. <br />Direto <br />Mostra url em href campo, JavaScript no campo onmousedown e os acessos são contados através do JavaScript.');
    ...
    define('_AM_WEBLINKS_RECOMMEND_PRI_DSC',
           'NENHUM <br />Não mostra.<br />Normal <br />Sites recomendados são mostrados no cabeçalho.<br />Mais alto <br />Mostra os sites recomendados no topo da respectiva categoria.');
    define('_AM_WEBLINKS_MUTUAL_PRI', 'Prioridade de Reciprocidade de Sites');
    define('_AM_WEBLINKS_MUTUAL_PRI_DSC',
           'NENHUM <br />Não mostra.<br />Normal <br />Sites recíprocos são mostrados no cabeçalho.<br />Mais alto <br />Mostra os sites recíprocos no topo da respectiva categoria');
    ...
    define('_AM_WEBLINKS_CONF_GM_APIKEY_DESC',
           'Obter a chave API em <br/> <a href="http://www.google.com/apis/maps/signup.html" target="_blank">http://www.google.com/apis/maps/signup.html</a> <br/> Quando você usar o GoogleMaps.');
    ...
    define('_AM_WEBLINKS_CONF_PERFORMANCE_DSC',
           'Por causa da melhoria na performance, isso processa os dados necessários antes, quando mostrado, e os armazena no banco de dados.<br />Quando usado pela primeira vez, execute "lista de categoria" -> "Atualização do percurso da árvore da categoria"');
    ...
    define('_AM_WEBLINKS_USE_CAPTCHA_DSC',
           'CAPTCHA é uma tecnica para anti-spam.<br />Esta característica precisa do módulo Captcha.<br />YES, <b>usuário anônimo</b> deve usar CAPTCHA quando adicionar ou modificar um link.<br />NÃO não mostra o campo CAPTCHA.');
    ...
    define('_AM_WEBLINKS_GM_GEOCODE_KIND_DESC',
           'Buscar latitude e longitude para o endereço<br /><b>Resultado único</b><br />GClientGeocoder - getLatLng<br /><b>Mais resultados</b><br />GClientGeocoder - getLocations');
    ...
    define('_AM_WEBLINKS_GM_USE_NISHIOKA_DESC',
           'Válido no Japão<br />Buscar endereço para a latitude e longitude<br /><a href="http://nishioka.sakura.ne.jp/google/" target="_blank">http://nishioka.sakura.ne.jp/google/</a>');
    ...
    define('_AM_WEBLINKS_HEADER_MODE_DESC',
           'Quando "Não", mostra a folha de estilo e tag Javascript no corpo<br />Quando "Sim", mostra as tags no cabeçalho, usando o cabeçalho do módulor xoops<br />existem alguns temas que não podem ser usados');
