...
if (!defined('WEBLINKS_LANG_MI_LOADED')) {
    ...
    define('_MI_WEBLINKS_BROKENDSC',
           'Informe quantidade de link broken para parar exibição. <br /> Quando abaixo deste valor, será considerado como um erro temporário, e não executa nada. <br />Quando ultrapassar este valor, será considerado um erro para correção, e para a exibição.');
    ...
    define('_MI_WEBLINKS_TOPTEN_CATS_DSC',
           'Informe o número máximo de categorias a serem mostradas em "Site Popular" e "Site melhor avaliado". <br />Tempo esgotado pode ocorrer se muitas categorias top forem selecionadas');
