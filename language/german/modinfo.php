...
if (!defined('WEBLINKS_LANG_MI_LOADED')) {
    ...
    define('_MI_WEBLINKS_TOPTEN_CATS_DSC',
           "Festlegen der maximalen Anzahl an Kategorien die in \"Populäre Seiten\" und \"Best bewertete Seiten\" angezeigt werden. <br />Zeitüberschreitung kann durch zu viele Kategorien verursacht werden");
