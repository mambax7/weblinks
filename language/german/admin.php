...
if (!defined('WEBLINKS_LANG_AM_LOADED')) {
    ...
    define('_WEBLINKS_CAT_IMG_MODE_DSC',
           'Wenn <b>KEINE</b>, erfolgt keine Kategoriegrafik. <br />Wenn <b>folder.gif</b>, wird diese Grafik angezeigt. <br />Wenn<b>Auswahlgrafik</b>, wird gewählte Grafikdatei aus der Kategorieeinstellung angezeigt. ');
    ...
    define('_WEBLINKS_ADMIN_LINK_BROKEN_CHECK_CAUTION',
           'Ein timeout ist aufgetreten, es gibt viele ungültige Links.<br />Bitte eine Maximalanzahl der zu überprüfenden Links wählen.<br />Bei Auswahl =0 gibt es keine Beschränkungen. <br />');
    ...
    define('_AM_WEBLINKS_USE_PASSWD_DSC',
           'Wenn JA gewählt,<br />können <b>anonyme Benutzer</b> einen Link durch Passwort Authentifizierung ändern.<br />Wenn NEIN gewählt, <br />wird das Pwsswort Feld nicht angezeigt.');
    ...
    define('_AM_WEBLINKS_VIEW_URL_DSC',
           "Wenn \"kein\" gewählt, <br />werden url und &lt;a&gt; tag nicht angezeigt.<br />Wenn \"Indirekt\" gewählt, <br />zeige visit.php im href Feld anstatt der URL. <br />Wenn \"Direkt\" gewählt, <br />zeige url im href Feld, JavaScript im onmousedown Feld und Zugriffe werden mit JavaScript gezählt.");
    ...
    define('_AM_WEBLINKS_RECOMMEND_PRI_DSC',
           "Wenn \"keine\" gewählt, <br />keine Anzeige.<br />Wenn \"Normal\" gewählt, <br />Anzeige im Header.<br />Wenn \"Höher\" gewählt, <br />Anzeige in höherem Rang in jeder Kategorie.");
    ...
    define('_AM_WEBLINKS_CONF_COUNTRY_CODE_DESC',
           "Eingabe ccTLDs code (f&uuml;r Deutschland ist es: de)<br/> <a href=\"http://www.iana.org/cctld/cctld-whois.htm\" target=\"_blank\">IANA: Country-Code Top-Level Domains</a>");
    ...
    define('_AM_WEBLINKS_CONF_GM_APIKEY_DESC',
           "Holen Sie sich einen API key auf <br/> <a href=\"http://www.google.com/apis/maps/signup.html\" target=\"_blank\">http://www.google.com/apis/maps/signup.html</a> <br/> wenn Sie GoogleMaps benutzen.");
    ...
    define('_AM_WEBLINKS_CONF_PERFORMANCE_DSC',
           "Zur Leistungssteigerung werden benötigte Daten im voraus berrechnet und in der Datenbank gespeichert.<br />Bei der ersten Verwendung führen Sie bitte \"Kategorie Liste\" -> \"Aktualisiere Kategorie Verzeichnispfad\" aus");
    ...
    define('_AM_WEBLINKS_USE_CAPTCHA_DSC',
           'CAPTCHA ist eine Technik zur SPAM Vermeidung.<br />Dieses Option benötigt das CAPTCHA Modul.<br />JA, <b>anoyme Benutzer</b> müssen CAPTCHA benutzen um einen Link einzusenden oder zu ändern.<br />NEIN zeigt das CAPTCHA Feld nicht an.');
