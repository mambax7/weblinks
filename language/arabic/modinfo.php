...
if (!defined('WEBLINKS_LANG_MI_LOADED')) {
    ...
    define('_MI_WEBLINKS_BROKENDSC',
           'ÇÏÎá ÚÏÏ ÊÞÇÑíÑ ÇáÑæÇÈØ ÇáÊí áÇ ÊÚãá áÊæÞÝ ÚÑÖ ÇáãÒíÏ ãäåÇ. <br /> When below this value, it will be regarded as a temporary error, and nothing will be done. <br />When over this value the link will no longer be displayed.');
