...
if (!defined('WEBLINKS_LANG_AM_LOADED')) {
    ...
    define('_WEBLINKS_CAT_IMG_MODE_DSC',
           '"áÇ ÊÚÑÖ" (ÈÏæä ÕæÑÉ )<br> folder.gif (ÇíŞæäÉ ãÌáÏ)<br>"ÎíÇÑÇÊ ÇáÕæÑÉ" (( ÇáÕæÑÉ ÇáÊí ÇÎÊÑÊåÇ ááŞÓã ) ŞÓã &nbsp;&gt;&gt;ŞÓã ÇáİÑÚí &gt;&gt;)<br>"ÅÑÌÇÚ ÇáÃíŞæäÉ" İí ÍÇáÉ ÏÎæá ÇáŞÓã ((folder.gif) ŞÓã &nbsp;&gt;&gt;ŞÓã ÇáİÑÚí &gt;&gt;) <br> ÇÏÎá Úáí ÇÍÏ ÇáÇŞÓÇã æÛíÑ ãä åäÇ æáÇÍÙ ÇáÊÛíÑ İí ÇáÕæÑÉ ÇáÊí ÇÎÊÑÊåÇ ÇäÊ ááŞÓã');
    ...
    define('_WEBLINKS_ADMIN_LINK_BROKEN_CHECK_CAUTION',
           'ÇäÊåÇÁ ÇáæŞÊ ŞÏ íÍÏË¡ ÅĞÇ åäÇß ÇáÚÏíÏ ãä ÑæÇÈØ áÇ ÊÚãá. <br /> ÅĞÇ ßÇä ÇáÃãÑ ßĞáß¡ ÑÌÇÁ ÛíÑ ÇáŞíãÉ ÇáÚÏÏíÉ æÇáÈÏÃ. <br /> ÇáŞíãÉ = 0¡ Ãæ ÈÏæä ŞíæÏ.');
    ...
    define('_AM_WEBLINKS_VIEW_URL_DSC',
           '"áÇ ÔíÆ"  ÚÏã ÚÑÖ ÇáÑÇÈØ äåÇÆí. <br /> "ÛíÑ ãÈÇÔÑ" íÚÑÖ ÇáÑÇÈØ ãËÇá visit.php?lid=2   . <br /> "ãÈÇÔÑ" íÚÑÖ ÚäæÇä ÇáãæŞÚ ÚäÏ ãÑæÑ ÇáİÃÑÉ İæŞ ÇáÑÇÈØ (ÌÇİÇ ÓßÑÈÊ).');
    ...
    define('_AM_WEBLINKS_CONF_PERFORMANCE_DSC',
           'ÈÓÈÈ ÊÍÓíä ÇáÃÏÇÁ¡ ÊÍÓÈ ÇáÈíÇäÇÊ ãŞÏãÇ ÚäÏãÇ ÊÚÑÖ¡ æÊÎÒä İí ŞÇÚÏÉ ÇáÈíÇäÇÊ. <br /> ÚäÏãÇ ÅÓÊÚãÇá Ãæá ãÑÉ¡ ÊäİĞ ãä "ŞÇÆãÉ ÇáÃŞÓÇã" -> "ÊÍÏíË ãÓÇÑ ÇáÃŞÓÇã"');
